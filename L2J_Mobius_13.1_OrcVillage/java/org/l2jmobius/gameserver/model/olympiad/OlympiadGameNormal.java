...
public abstract class OlympiadGameNormal extends AbstractOlympiadGame
{
	...
	protected void validateWinner(OlympiadStadium stadium)
	{
		...
		try
		{
			...
			{
				resultP1 = new ExOlympiadMatchResult(true, winside, list1, list2, _winnerRound1.equalsIgnoreCase(_playerTwo.getName()) ? 2 : _winnerRound1.isEmpty() ? 0 : 1, _winnerRound2.equalsIgnoreCase(_playerTwo.getName()) ? 3 : 2, !_winnerRound3.isEmpty() && _winnerRound3.equalsIgnoreCase(_playerTwo.getName()) ? 3 : _winnerRound3.isEmpty() ? 0 : 2, list1.get(0).getCurrentPoints(), list1.get(0).getDiffPoints());
			}
			...
			{
				resultP2 = new ExOlympiadMatchResult(true, winside, list1, list2, _winnerRound1.equalsIgnoreCase(_playerTwo.getName()) ? 2 : _winnerRound1.isEmpty() ? 0 : 1, _winnerRound2.equalsIgnoreCase(_playerTwo.getName()) ? 3 : 2, !_winnerRound3.isEmpty() && _winnerRound3.equalsIgnoreCase(_playerTwo.getName()) ? 3 : _winnerRound3.isEmpty() ? 0 : 2, list2.get(0).getCurrentPoints(), list2.get(0).getDiffPoints());
			}
